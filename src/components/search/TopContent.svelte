<section class="wrapper image-wrapper bg-image bg-overlay bg-overlay-900 bg-overlay-900 "
	data-image-src="/images/landing/descan_11.JPG">
		...
		<div class="row gx-lg-8 gy-8 mt-1 mt-md-12 mt-lg-0 mb-3 align-items-center">
			<div class="col-lg-6 order-lg-2">
				<div class="row gx-md-5 gy-5" data-cues="fadeIn" data-group="images">
					...
					<div class="col-md-9  pb-4 text-center">
            ...
            <div class="col-lg-6 text-white">
				<div data-cues="slideInDown"
				  ...
				  <p class="lead fs-24 lh-sm text-white mb-7">Propinsi Sumatera Selatan sejak berabad yang lalu dikenal juga dengan sebutan Bumi Sriwijaya, pada abad ke-7 hingga abad ke-12 Masehi wilayah ini merupakan pusat kerajaan Sriwijaya yang juga terkenal dengan kerajaan maritim terbesar dan terkuat di Nusantara</p>
				</div>
			</div>
		</div>
	</div>
