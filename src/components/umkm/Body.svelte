      ...
      <div class="col-lg-4 text-center text-lg-start">
        ...
        <div class="mt-2">
          <button
            ...
            data-bs-target="#modal_industri">Selengkapnya</button
          >
        </div>
      </div>
      <!-- /column -->
          ...
          {#if industri.length > 0}
            {#each Array(6) as _, i}
              <div class="col-md-4">
                ...
                <p>
                  {industri[i].nama_variabel.replace(
        ...
        >
          <thead>
            <tr>
              ...
              <th scope="col" class="bg-primary  text-center  text-white"
                >Industri</th
              >
              <th scope="col" class="bg-primary text-center text-white "
                >Jumlah</th
...
{:else}
  <section class="wrapper bg-light">
    <div class="container py-6 py-md-8">
      <h3>Loading... UMKM Pada Wilayah Ini</h3>
    </div>
  </section>
{/if}
