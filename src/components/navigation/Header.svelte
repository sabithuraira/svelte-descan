...
<header class="wrapper bg-soft-primary">
    <nav class="navbar navbar-expand-lg center-logo bg-image position-absolute navbar-dark"
		...
		<div class="container justify-content-between align-items-center mx-1 " style="max-width:100%">
			...
			<div class="navbar-brand py-2"><a href="/">
			...
			<div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
				...
				<ul class="navbar-nav">
					<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="/profile/{kode}">Profile</a>
					<ul class="dropdown-menu">
						<li class="nav-item"><a class="dropdown-item" href="/monograph/{kode}">Monograph</a></li>
						<li class="nav-item"><a class="dropdown-item" href="/organisasi/{kode}">Organisasi</a></li>
					</ul>
					</li>
					<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#"
						data-bs-toggle="dropdown">Kependudukan</a>
					<ul class="dropdown-menu">
						<li class="nav-item"><a class="dropdown-item" href="/kemiskinan/{kode}">Kemiskinan</a></li>
						<li class="nav-item"><a class="dropdown-item" href="/stunting/{kode}">Stunting</a></li>
						<li class="nav-item"><a class="dropdown-item" href="/penduduk/{kode}">Penduduk</a></li>
					</ul>
					</li>
					<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#"
						data-bs-toggle="dropdown">Ekonomi</a>
					<ul class="dropdown-menu">
						<li class="nav-item"><a class="dropdown-item" href="/umkm/{kode}">UMKM</a></li>
					</ul>
					</li>
					<li class="nav-item">
