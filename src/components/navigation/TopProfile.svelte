			...
			<div class="col-lg-6 text-white">
				<div data-cues="slideInDown" data-group="page-title" data-delay="600">
                    <h1 class="display-1 text-white" style="display: inline-block;" id="desa_text">
                        { labelLevel(info_wilayah.kode_wilayah) } { info_wilayah.nama }
                        <span class="typer text-white"
                            data-words="{ labelLevel(info_wilayah.kode_wilayah) } { info_wilayah.nama }"
                            data-loop="false"></span>
                        <span class="cursor text-white" data-owner="typer"></span>
                    </h1>
                    <div data-cues="slideInDown" data-group="page-title" data-delay="600">
                        <p class="lead fs-24 lh-sm text-white mb-1" style="min-height: 280px;">{ $deskripsi }</p>
                    </div>
				</div>
			</div>
		</div>
