!(function (e, t) {
      ...
      trigger(e, t, i) {
        ...
        return (
          ...
          u
            ...
            : (c = new CustomEvent(t, { bubbles: o, cancelable: !0 })),
          void 0 !== i &&
  ...
  const pe = "collapse",
    me = "bs.collapse";
  me;
  const fe = { toggle: !0, parent: null },
    ge = { toggle: "boolean", parent: "(null|element)" };
  const ve = "show",
    ye = "collapse",
    be = "collapsing",
    we = "collapsed",
  ...
  class Ee extends V {
    ...
    show() {
      if (!this._isTransitioning && !this._isShown()) {
        ...
        if (!v.trigger(this._element, "show.bs.collapse").defaultPrevented) {
          e.forEach((e) => {
            s !== e && Ee.getOrCreateInstance(e, { toggle: !1 }).hide(),
              t || X.set(e, me, null);
          });
    ...
    _getConfig(e) {
      return (
        ((e = { ...fe, ...r.getDataAttributes(this._element), ...e }).toggle =
          Boolean(e.toggle)),
        (e.parent = n(e.parent)),
        p(pe, e, ge),
        e
      ...
      a =
        !0 === e
          ? ((a = (l = o).x),
            ...
            { x: st(st(a * c) / c) || 0, y: st(st(l * c) / c) || 0 })
          : "function" == typeof e
          ? e(o)
          : o,
      l = a.x,
  ...
  function Ct(e, t) {
    var s,
      ...
      r = St({ reference: n, element: l, strategy: "absolute", placement: i }),
  ...
  var Lt = {
    ...
    fn: function (d) {
      var u,
        ...
        y = Ct(n, { boundary: y, rootBoundary: o, padding: a, altBoundary: b }),
        o = Ye(n.placement),
        b = !(a = lt(n.placement)),
        x = "x" === (o = et(o)) ? "y" : "x",
  ...
  class ui {
    ...
    _getConfig(e) {
      return (
        ((e = { ...ai, ...("object" == typeof e ? e : {}) }).rootElement = n(
          e.rootElement
        )),
        p(ci, e, li),
        e
  ...
  const hi = { trapElement: null, autofocus: !0 },
    pi = { trapElement: "element", autofocus: "boolean" };
  ...
  class Ai extends V {
    ...
    show(e) {
      this._isShown ||
        this._isTransitioning ||
        v.trigger(this._element, xi, { relatedTarget: e }).defaultPrevented ||
        ((this._isShown = !0),
      ...
      return (
        ...
        h(a, function (e) {
          ...
          ((e.addEventListener && r && !t.found) || !r) &&
            (e.addEventListener(i, l, o), t.all.push({ eventName: i, fn: l }));
        }),
        l
      );
    }
  ...
  (function (e, r) {
    ...
    e.console && console.warn,
      ...
      (w.parseSets = function (e, t, i) {
        ...
        a.srcset
          ? ((n = { srcset: a.srcset, sizes: z.call(e, "sizes") }),
            a.sets.push(n),
            (r = (g || a.src) && R.test(a.srcset || "")) ||
              ...
              n.has1x ||
              ((n.srcset += ", " + a.src),
              n.cands.push({ url: a.src, d: 1, set: n })))
      ...
      (e.picturefillCFG = {
        ...
        push: function (e) {
          ...
          "function" == typeof w[t]
            ? w[t].apply(w, e)
            : ((j[t] = e[0]), Z && w.fillImgs({ reselect: !0 }));
        },
      });
  ...
  "object" == typeof navigator &&
    (function (e, t) {
      ...
      const w = {
        ...
        createIcon(e, t) {
          const i = "http://www.w3.org/2000/svg",
            ...
            o =
              (se(r, te(t, { "aria-hidden": "true", focusable: "false" })),
          ...
          switch (
            ...
            Object.keys(i).includes("class")
              ? i.class
                ...
                te(i, { class: i.class + " " + this.config.classNames.control })
        ...
        create(a) {
          const {
            ...
            r =
              ((this.elements.controls = n), { class: "plyr__controls__item" });
          return (
              ...
              (t) => {
                ...
                if (
                  ...
                  if (
                    ((g(e) && n.contains(e)) ||
                      ((e = y(
                        "div",
                        te({}, r, { class: (r.class + " plyr__volume").trim() })
                      )),
                ...
                if (
                  ...
                  const e = y(
                    ...
                    c = y("div"),
                    t = y("div", { id: `plyr-settings-${a.id}-home` }),
                    o = y("div", { role: "menu" });
                  t.appendChild(o),
                    c.appendChild(t),
                    ...
                    this.config.settings.forEach((e) => {
                      ...
                      r.appendChild(
                        y("span", { "aria-hidden": !0 }, De.get(e, this.config))
                      ),
                        r.appendChild(
                          y(
                            "span",
      ...
      const x = {
        ...
        Ve = { html5: "html5", youtube: "youtube", vimeo: "vimeo" },
        Ge = () => {};
      class Ue {
        constructor(e = !1) {
      ...
      const st = {
        ...
        ready() {
          ...
          Object.defineProperty(o.media, "loop", {
            ...
            Object.defineProperty(o.media, "currentSrc", { get: () => m }),
...
"object" == typeof exports && "undefined" != typeof module
  ...
  (function (a, h) {
    var t,
      ...
      O = h[p]("a"),
      I = typeof SVGRect != f,
      c = { useCache: !0, copyAttributes: !0, makeIdsUnique: !0 },
      L = {
        clipPath: ["clip-path"],
        "color-profile": w,
        cursor: w,
  ...
  (function (e, t) {
      ...
      constructor(e) {
        if ("number" == typeof e) super(e);
          ...
          super(...(e || []));
          {
            e = this;
            const t = e.__proto__;
            void Object.defineProperty(e, "__proto__", {
              get: () => t,
              set(e) {
                t.__proto__ = e;
              },
    ...
    const d = {
      ...
      on: function () {
        ...
        function c(t) {
          ...
          if (e) {
            ...
            if ((i.indexOf(t) < 0 && i.unshift(t), I(e).is(n))) r.apply(e, i);
            else {
              const t = I(e).parents();
              for (let e = 0; e < t.length; e += 1)
                I(t[e]).is(n) && r.apply(t[e], i);
            }
          }
        }
        function d(e) {
        ...
        "function" == typeof i[1] && (([s, r, o] = i), (n = void 0)),
          (o = o || !1);
        var a = s.split(" ");
        let l;
        for (let e = 0; e < this.length; e += 1) {
          ...
          if (n)
            for (l = 0; l < a.length; l += 1) {
              ...
              i.dom7LiveListeners || (i.dom7LiveListeners = {}),
                ...
                i.dom7LiveListeners[t].push({ listener: r, proxyListener: c }),
                i.addEventListener(t, c, o);
            }
          else
            for (l = 0; l < a.length; l += 1) {
              const t = a[l];
              i.dom7Listeners || (i.dom7Listeners = {}),
                ...
                i.dom7Listeners[t].push({ listener: r, proxyListener: d }),
                i.addEventListener(t, d, o);
            }
        }
        return this;
      },
      off: function () {
        for (var e = arguments.length, i = new Array(e), s = 0; s < e; s++)
          i[s] = arguments[s];
        let [t, n, r, o] = i;
        "function" == typeof i[1] && (([t, r, o] = i), (n = void 0)),
          (o = o || !1);
        var a = t.split(" ");
        for (let e = 0; e < a.length; e += 1) {
          ...
          for (let e = 0; e < this.length; e += 1) {
            ...
            if (
              (!n && s.dom7Listeners
                ? (t = s.dom7Listeners[i])
                : n && s.dom7LiveListeners && (t = s.dom7LiveListeners[i]),
              t && t.length)
            )
              for (let e = t.length - 1; 0 <= e; --e) {
                ...
                (!(
                  ...
                  r) ||
                  (s.removeEventListener(i, n.proxyListener, o),
                  t.splice(e, 1));
              }
          }
        }
      ...
      is: function (e) {
        ...
        if ("string" == typeof e) {
          ...
          for (n = I(e), r = 0; r < n.length; r += 1) if (n[r] === s) return !0;
          return !1;
        }
        if (e === i) return s === i;
        if (e === t) return s === t;
      ...
      parents: function (i) {
        ...
        for (let t = 0; t < this.length; t += 1) {
          ...
          for (; e; ) (i && !I(e).is(i)) || s.push(e), (e = e.parentNode);
        }
        return I(s);
      },
      closest: function (e) {
            ...
            void 0 !== o &&
              ...
              (u(i[r]) && u(s[r])
                ? s[r].__swiper__
                  ...
                  : h(i[r], s[r])
                : !u(i[r]) && u(s[r])
                ? ((i[r] = {}), s[r].__swiper__ ? (i[r] = s[r]) : h(i[r], s[r]))
                : (i[r] = s[r]));
          }
        }
      }
    ...
    function b(e) {
      ...
      const h = i.params.speed,
        ...
        u = () => {
          ...
          let t = o + e * (s - o);
          if ((d(t, s) && (t = s), i.wrapperEl.scrollTo({ [n]: t }), d(t, s)))
            return (
    ...
    function p(e) {
      ...
      if (
        ...
        if ("reset" === o) return t.emit("slideResetTransition" + n), 0;
    ...
    Object.keys(d).forEach((e) => {
      Object.defineProperty(I.fn, e, { value: d[e], writable: !0 });
    });
    let x = !1;
    function T() {}
    const S = (e, t) => {
    ...
    const M = {
            ...
            return (
              (s =
                "string" == typeof r[0] || Array.isArray(r[0])
                  ? ((t = r[0]), (i = r.slice(1, r.length)), e)
                  : ((t = r[0].events), (i = r[0].data), r[0].context || e)),
              i.unshift(s),
            ...
            if (void 0 !== o) {
              ...
              if (
                ...
                a &&
                  ...
                  h.css({ width: i.virtualSize + r.spaceBetween + "px" }),
                r.setWrapperSize &&
                  h.css({
        ...
        loop: {
          loopCreate: function () {
            const s = this,
              ...
              n = 0 < e.children().length ? I(e.children()[0].parentNode) : e;
            ...
            if (i.loopFillGroupWithBlank) {
              ...
              if (s !== i.slidesPerGroup) {
                for (let e = 0; e < s; e += 1) {
                  const s = I(t.createElement("div")).addClass(
          ...
          attachEvents: function () {
            ...
            (e.onTouchStart = function (e) {
              ...
              if (t && (!s.animating || !o.preventInteractionOnTransition)) {
                ...
                let t = e,
                  i = (t.originalEvent && (t = t.originalEvent), I(t.target));
                if (
                  ...
                  if (
                    ...
                    if (
                      ...
                      let e = !0;
                      i.is(r.focusableElements) &&
                        ((e = !1),
                        "SELECT" === i[0].nodeName && (r.isTouched = !1)),
                        n.activeElement &&
                          I(n.activeElement).is(r.focusableElements) &&
                          n.activeElement !== i[0] &&
                ...
                if (t) {
                  ...
                  if ((s.originalEvent && (s = s.originalEvent), o.isTouched)) {
                    if (!o.isTouchEvent || "touchmove" === s.type) {
                      ...
                      if (!r.allowTouchMove)
                        return (
                          I(s.target).is(o.focusableElements) ||
                            (r.allowClick = !1),
                          void (
                            o.isTouched &&
                            (Object.assign(l, {
                      ...
                      u > a.longSwipesMs
                        ? a.longSwipes
                          ? ("next" === o.swipeDirection &&
                              (r >= a.longSwipesRatio
                                ? o.slideTo(a.rewind && o.isEnd ? e : t + d)
                                : o.slideTo(t)),
                            "prev" === o.swipeDirection &&
                              (r > 1 - a.longSwipesRatio
                                ? o.slideTo(t + d)
                                : null !== s &&
                                  r < 0 &&
                                  Math.abs(r) > a.longSwipesRatio
                                ? o.slideTo(s)
                                : o.slideTo(t)))
                        ...
                        ? !o.navigation ||
                          ...
                          ? ("next" === o.swipeDirection &&
                              o.slideTo(null !== e ? e : t + d),
                            "prev" === o.swipeDirection &&
                              o.slideTo(null !== s ? s : t))
                          : n.target === o.navigation.nextEl
                          ? o.slideTo(t + d)
                          : o.slideTo(t)
                        : o.slideTo(o.activeIndex);
              ...
              s.touch && !x && (t.addEventListener("touchstart", T), (x = !0)),
              S(e, "on");
          },
          ...
          getBreakpoint: function (e, i, s) {
            if (
              ...
              for (let e = 0; e < o.length; e += 1) {
                const { point: O, value: r } = o[e];
                "window" === i
                  ? n.matchMedia(`(min-width: ${r}px)`).matches && (t = O)
                  : r <= s.clientWidth && (t = O);
              }
              return t || "max";
            }
        ...
        images: {
          loadImage: function (e, t, i, s, n, r) {
            ...
            !(I(e).parent("picture")[0] || (e.complete && n)) && t
              ? ((a = new o.Image()),
                (a.onload = l),
                (a.onerror = l),
                s && (a.sizes = s),
      ...
      mount(t) {
        ...
        let n = (() => {
          if (t && t.shadowRoot && t.shadowRoot.querySelector) {
            const e = I(t.shadowRoot.querySelector(s()));
    ...
    function N(e) {
      ...
      if (s.params.virtualTranslate && 0 !== t) {
        let e,
          i = !1;
        (e = r ? (n ? o.find(n) : o) : n ? o.eq(a).find(n) : o.eq(a)),
          e.transitionEnd(() => {
            if (!i && s && !s.destroyed) {
              (i = !0), (s.animating = !1);
    ...
    return (
      ...
      c.use([
        ...
        function (e) {
          ...
          function n() {
            u.keyboard.enabled ||
              (I(p).on("keydown", s), (u.keyboard.enabled = !0));
          }
          function r() {
            u.keyboard.enabled &&
              (I(p).off("keydown", s), (u.keyboard.enabled = !1));
          }
        ...
        function (r) {
          let { swiper: c, extendParams: o, on: e, emit: d } = r;
          const a = O();
          let u;
          o({
            mousewheel: {
          ...
          function f(e) {
            return (
              ...
              !(
                ...
                v() - t < c.params.mousewheel.thresholdTime
              ) &&
              ((6 <= e.delta && v() - t < 60) ||
                (e.direction < 0
            ...
            if (c.enabled) {
              ...
              if (
                ("container" !== c.params.mousewheel.eventsTarget &&
                  (e = I(c.params.mousewheel.eventsTarget)),
                !c.mouseEntered &&
          ...
          function g(e) {
            let t = c.$el;
            "container" !== c.params.mousewheel.eventsTarget &&
              (t = I(c.params.mousewheel.eventsTarget)),
              t[e]("mouseenter", l),
              t[e]("mouseleave", m),
              t[e]("wheel", i);
          }
          function s() {
            return c.params.cssMode
              ...
              : !c.mousewheel.enabled && (g("on"), (c.mousewheel.enabled = !0));
          }
          function n() {
            return c.params.cssMode
              ? (c.wrapperEl.addEventListener(event, i), !0)
              : !!c.mousewheel.enabled &&
                  (g("off"), !(c.mousewheel.enabled = !1));
          }
          e("init", () => {
        ...
        function (e) {
          let { swiper: r, extendParams: d, on: t, emit: u } = e;
          function s(e) {
            let t;
            return (
              e &&
            ...
            t("click", (e, t) => {
              ...
              if (
                ...
                i
                  ...
                  u(!0 === e ? "navigationShow" : "navigationHide"),
        ...
        function (e) {
          let { swiper: c, extendParams: n, on: t, emit: d } = e;
          e = "swiper-pagination";
          let u,
            h =
              (n({
          ...
          function i() {
            ...
            if (!r()) {
                  ...
                  if ((t.addClass(o.bulletActiveClass), o.dynamicBullets)) {
                    ...
                    if (c.params.loop)
                      if (l >= a.length) {
                        ...
                        a.eq(a.length - o.dynamicMainBullets - 1).addClass(
              ...
              if (
                ("fraction" === o.type &&
                  (l
                    .find(y(o.currentClass))
                    .text(o.formatFractionCurrent(r + 1)),
                  l.find(y(o.totalClass)).text(o.formatFractionTotal(i))),
                "progressbar" === o.type)
              ) {
          ...
          function s() {
            ...
            if (!r()) {
              ...
              if ("bullets" === s.type) {
                ...
                n.html(i), (c.pagination.bullets = n.find(y(s.bulletClass)));
              }
              "fraction" === s.type &&
                ((i = s.renderFraction
            ...
            if (t.el) {
              ...
              0 !== e.length &&
                (c.params.uniqueNavElements &&
                  ...
                  ((e = c.$el.find(t.el)),
                  1 < e.length &&
                    (e = e.filter((e) => I(e).parents(".swiper")[0] === c.el))),
                "bullets" === t.type &&
                  t.clickable &&
                ...
                t.clickable &&
                  e.on("click", y(t.bulletClass), function (e) {
                    e.preventDefault();
                    let t = I(this).index() * c.params.slidesPerGroup;
          ...
          function a() {
            ...
            if (!r()) {
              ...
              t.removeClass(e.hiddenClass),
                ...
                e.clickable && t.off("click", y(e.bulletClass));
            }
          }
          t("init", () => {
            o(), s(), i();
            ...
            t("click", (e, t) => {
              ...
              if (
                ...
                0 < s.length &&
                !I(i).hasClass(c.params.pagination.bulletClass) &&
                (!c.navigation ||
                  !(
        ...
        function (i) {
          let { swiper: c, extendParams: n, on: e, emit: o } = i;
          const p = E();
          let a,
            l,
            d,
          ...
          function x() {
            ...
            if (n.el) {
              ...
              0 === t.length &&
                ((t = I(`<div class="${c.params.scrollbar.dragClass}"></div>`)),
                e.append(t)),
                Object.assign(i, {
                  $el: e,
                  el: e[0],
        ...
        function (i) {
          let { swiper: x, extendParams: s, on: e, emit: n } = i;
          const S = O();
          s({
            zoom: {
              enabled: !1,
          ...
          function h(e) {
            ...
            if (((r = !1), (o = !1), !t.gestures)) {
              if (
                ...
                return;
              (r = !0), (E.scaleStart = u(e));
            }
            (E.$slideEl && E.$slideEl.length) ||
            ((E.$slideEl = I(e.target).closest("." + x.params.slideClass)),
            0 === E.$slideEl.length &&
          ...
          function m(e) {
            ...
            if (
              ...
              _.isMoved ||
                ...
                (_.startX = L(E.$imageWrapEl[0], "x") || 0),
                (_.startY = L(E.$imageWrapEl[0], "y") || 0),
          ...
          function g(y) {
            ...
            if (
              (E.$slideEl ||
                (y &&
                  y.target &&
                  (E.$slideEl = I(y.target).closest("." + x.params.slideClass)),
                E.$slideEl ||
          ...
          function C(e) {
            var t = b()["passiveListener"],
              i = w();
            x.$wrapperEl[e]("gesturestart", i, h, t),
          ...
          function M() {
            ...
            e.enabled ||
              ...
              (n = w()),
              t.gestures
                ? (x.$wrapperEl.on(x.touchEvents.start, k, i),
                  x.$wrapperEl.on(x.touchEvents.end, A, i))
                : "touchstart" === x.touchEvents.start &&
                  (x.$wrapperEl.on(x.touchEvents.start, n, h, i),
                  x.$wrapperEl.on(x.touchEvents.move, n, p, s),
          ...
          function P() {
            ...
            e.enabled &&
              ...
              (n = w()),
              t.gestures
                ? (x.$wrapperEl.off(x.touchEvents.start, k, i),
                  x.$wrapperEl.off(x.touchEvents.end, A, i))
                : "touchstart" === x.touchEvents.start &&
                  (x.$wrapperEl.off(x.touchEvents.start, n, h, i),
                  x.$wrapperEl.off(x.touchEvents.move, n, p, s),
          ...
          function m() {
            ...
            if (
              ...
              t.children("." + i.slideVisibleClass).each((e) => {
                p(r ? I(e).attr("data-swiper-slide-index") : I(e).index());
              });
          ...
          function f() {
            ...
            if (d && !d.destroyed) {
              const s = d.params.lazy.scrollingElement
                  ? I(d.params.lazy.scrollingElement)
                  : I(e),
                n = s[0] === e,
            ...
            i("transitionStart", () => {
              d.params.lazy.enabled &&
                (d.params.lazy.loadOnTransitionStart ||
                  (!d.params.lazy.loadOnTransitionStart && !h)) &&
        ...
        function (t) {
          let { swiper: a, extendParams: r, on: e } = t,
            l =
              (r({
                a11y: {
                  enabled: !0,
          ...
          function h(e) {
            if (13 === e.keyCode || 32 === e.keyCode) {
              ...
              a.navigation &&
                ...
                a.pagination &&
                  i.is(y(a.params.pagination.bulletClass)) &&
                  i[0].click();
            }
          }
          function m() {
            ...
            e("afterInit", () => {
              if (a.params.a11y.enabled) {
                ...
                n.containerRoleDescriptionMessage &&
                  d(i, n.containerRoleDescriptionMessage),
                ...
                const s = a.$wrapperEl,
                  ...
                  o =
                    ...
                    n.itemRoleDescriptionMessage &&
                      d(I(a.slides), n.itemRoleDescriptionMessage),
                    c(I(a.slides), n.slideRole),
                    (a.params.loop
                      ? a.slides.filter(
                          (e) =>
                            !e.classList.contains(a.params.slideDuplicateClass)
                        )
                      : a.slides
                    ).length);
                let e, t;
                a.slides.each((e, t) => {
                  ...
                  f() &&
                    a.pagination.$el.on(
                      "keydown",
                      y(a.params.pagination.bulletClass),
                      h
                    ),
                  a.$el.on("focus", v, !0);
              } else;
            ...
            e("fromEdge toEdge afterInit lock unlock", () => {
              ...
              a.params.a11y.enabled &&
                (a.params.loop ||
                  ...
                  t &&
                    0 < t.length &&
                    (a.isBeginning ? (o(t), i(t)) : (p(t), n(t))),
                  e &&
                    0 < e.length &&
                    (a.isEnd ? (o(e), i(e)) : (p(e), n(e)))));
            }),
            e("paginationUpdate", () => {
              if (a.params.a11y.enabled) {
                ...
                m() &&
                  a.pagination.bullets.each((e) => {
                    ...
                    a.params.pagination.clickable &&
                      ...
                      t.is("." + a.params.pagination.bulletActiveClass)
        ...
        function (e) {
          let { swiper: o, extendParams: d, on: t } = e,
            a =
              (d({
                history: {
                  enabled: !1,
          ...
          const o = E(),
            ...
            l =
              ...
              () => {
                ...
                e === n.slides.eq(n.activeIndex).attr("data-hash") ||
                  (void 0 !==
                    (e = n.$wrapperEl
          ...
          s("init", () => {
            if (n.params.hashNavigation.enabled) {
              if (
                ...
                n.params.hashNavigation.watchState && I(a).on("hashchange", l);
              }
            } else;
          }),
            s("destroy", () => {
        ...
        function (d) {
          let i,
            { swiper: s, extendParams: u, on: e, emit: n } = d;
          function r() {
        ...
        function (e) {
          ...
          function r() {
            ...
            if (e) {
              ...
              if (
                !(
                  (s && I(s).hasClass(l.params.thumbs.slideThumbActiveClass)) ||
                  null == i
                )
              ) {
                let t;
                  ...
                  if (o < -h.minTranslate()) h.slideTo(h.activeIndex);
                    ...
                    if (a.freeMode.momentum) {
                      if (1 < u.velocities.length) {
                        ...
                        (h.velocity = p / m),
                          (h.velocity /= 2),
                          Math.abs(h.velocity) < a.freeMode.minimumVelocity &&
                            (h.velocity = 0),
                      ...
                      if (i < h.maxTranslate())
                        ...
                        (i =
                          Math.abs(d[t] - i) < Math.abs(d[t - 1] - i) ||
                    ...
                    (!a.freeMode.momentum || e >= a.longSwipesMs) &&
                      (h.updateProgress(),
                      h.updateActiveIndex(),
                      h.updateSlidesClasses());
                  }
        ...
        function (e) {
          ...
          t({ grid: { rows: 1, fill: "column" } }),
            (m.grid = {
              ...
              updateSlide: (e, t, i, d) => {
                var { slidesPerGroup: s, spaceBetween: n } = m.params,
                ...
                if ("row" === o && 1 < s) {
                  const h = Math.floor(e / (s * r)),
                    p = e - r * s * h,
                    m =
                      0 === h ? s : Math.min(Math.ceil((i - h * r * s) / r), s);
                  (c = Math.floor(p / m)),
                    (l = p - c * m + h * s),
                    (a = l + (c * u) / r),
            ...
            s({
              ...
              setTranslate: () => {
                const {
                  ...
                  u = g.isHorizontal(),
                  m = g.virtual && g.params.virtual.enabled;
                let s,
                  h = 0;
                d.shadow &&
                  (u
                    ? ((s = t.find(".swiper-cube-shadow")),
                      0 === s.length &&
                        ((s = I('<div class="swiper-cube-shadow"></div>')),
                        t.append(s)),
                      s.css({ height: i + "px" }))
                    : ((s = e.find(".swiper-cube-shadow")),
                      0 === s.length &&
                        ((s = I('<div class="swiper-cube-shadow"></div>')),
                        e.append(s))));
                for (let o = 0; o < a.length; o += 1) {
                  ...
                  let e = o,
                    t =
                      (m &&
                        (e = parseInt(g.attr("data-swiper-slide-index"), 10)),
                      90 * e),
                    i = Math.floor(t / 360);
                  p && ((t = -t), (i = Math.floor(-t / 360)));
                  const c = Math.max(Math.min(g[0].progress, 1), -1);
                  let s = 0,
                    n = 0,
                    r = 0;
                  e % 4 == 0
                ...
                var r = c.isSafari || c.isWebView ? -l / 2 : 0;
                t.transform(
                  `translate3d(0px,0,${r}px) rotateX(${
                    g.isHorizontal() ? 0 : h
                  }deg) rotateY(${g.isHorizontal() ? -h : 0}deg)`
                );
              },
              setTransition: (e) => {
                const { $el: t, slides: i } = g;
                i
                  .transition(e)
                  .find(
            ...
            s({
              ...
              setTranslate: () => {
                ...
                for (let a = 0, e = c.length; a < e; a += 1) {
                  const y = c.eq(a),
                    l = d[a],
                    p = ((m - y[0].swiperSlideOffset - l / 2) / l) * u.modifier;
                  let e = h ? f * p : 0,
                    t = h ? 0 : f * p,
                    i = -g * Math.abs(p),
                    s = u.stretch,
                    n =
                      ("string" == typeof s &&
                        -1 !== s.indexOf("%") &&
                        (s = (parseFloat(u.stretch) / 100) * l),
                      h ? 0 : s * p),
                    r = h ? s * p : 0,
                    o = 1 - (1 - u.scale) * Math.abs(p);
                  ...
                  if (
                    (z(u, y).transform(v),
                    (y[0].style.zIndex = 1 - Math.abs(Math.round(p))),
                    u.slideShadows)
                  ) {
                    let e = h
                    ...
                    0 === e.length && (e = D(u, y, h ? "left" : "top")),
                      0 === t.length && (t = D(u, y, h ? "right" : "bottom")),
                      e.length && (e[0].style.opacity = 0 < p ? p : 0),
                      t.length && (t[0].style.opacity = 0 < -p ? -p : 0);
                  }
                }
              },
              setTransition: (e) => {
          ...
          s({
            ...
            setTransition: (e) => {
              ...
              (t ? b.slides.find(t) : b.slides)
                ...
                .transition(e),
                N({ swiper: b, duration: e, transformEl: t, allSlides: !0 });
            },
                ...
                for (let o = 0; o < a.length; o += 1) {
                  ...
                  var p =
                    ...
                    y =
                      ...
                      d < h;
                  if (p || y) {
                    const a = (1 - Math.abs((Math.abs(g) - 0.5) / 0.5)) ** 0.5;
                    (n += -28 * g * a),
                      (s += -0.5 * a),
                      (r += 96 * a),
                      (i = -25 * a * Math.abs(g) + "%");
